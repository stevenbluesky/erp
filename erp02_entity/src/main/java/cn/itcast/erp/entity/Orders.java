...
public class Orders {
	...
	public String toString() {
		return "Orders [orderDetails=" + orderDetails + ", uuid=" + uuid + ", createtime=" + createtime + ", checktime="
				+ checktime + ", starttime=" + starttime + ", endtime=" + endtime + ", type=" + type + ", creater="
				+ creater + ", createrName=" + createrName + ", checker=" + checker + ", checkerName=" + checkerName
				+ ", starter=" + starter + ", starterName=" + starterName + ", ender=" + ender + ", enderName="
				+ enderName + ", supplieruuid=" + supplieruuid + ", supplierName=" + supplierName + ", totalmoney="
				+ totalmoney + ", state=" + state + ", waybillsn=" + waybillsn + "]";
	}
